    ...
    function famiTranslations()
    {
        static $translations = [
            'fr' => [
                ...
                'login.timeout' => 'Votre session a expire pour inactivite. Merci de vous reconnecter.',
                'login.error.invalid' => 'Identifiant ou mot de passe incorrect.',
                'login.username' => 'Identifiant',
                'login.password' => 'Mot de passe',
                'login.submit' => 'Se connecter',
                'login.help' => 'Identifiant ou mot de passe oublie ?',
                'index.workspace' => 'FamiJob Workspace',
                'index.logout' => 'Deconnexion',
                'index.kicker' => 'Espace de pilotage',
                'index.title' => 'FamiJob',
                'index.subtitle' => 'Gestion des horaires et des disponibilites interim',
                'index.role_prefix' => 'Profil',
                'role.admin' => 'Administrateur',
                'role.teamcoach' => 'TeamCoach',
                'tile.open' => 'Ouvrir',
                'tile.demands.title' => 'Demandes Horaires',
                'tile.demands.desc.admin' => 'Creer, modifier ou supprimer les demandes d\'horaires pour les agences interim.',
                'tile.demands.desc.teamcoach' => 'Consulter les demandes d\'horaires pour les agences interim.',
                'tile.matching.title' => 'Matching Interim',
                'tile.matching.desc.admin' => 'Assigner les etudiants aux creneaux interim, matching manuel ou automatique.',
                'tile.matching.desc.teamcoach' => 'Assigner les etudiants aux creneaux interim.',
                ...
                'tile.schedule.desc' => 'Consulter le planning hebdomadaire en lecture seule, par jours, plages horaires et departements.',
                'tile.relaunch.title' => 'Relance etudiant',
                'tile.relaunch.desc' => 'Envoyer des mails groupes selon la disponibilite et le rayon des etudiants.',
                'tile.availability.title' => 'Disponibilites Etudiants',
                'tile.availability.desc' => 'Vue par semaine et par secteur des disponibilites etudiantes.',
                'tile.interim_fixes.title' => 'Horaires Fixes Interimaires',
                'tile.interim_fixes.desc' => 'Configurer les horaires fixes (semaine A/B) des interimaires par departement. Validation automatique, sans approbation.',
                'interim_fixes.page_title' => 'Horaires Fixes Interimaires',
                ...
                'interim_fixes.empty.none' => 'Aucun interimaire trouve.',
                'interim_fixes.empty.help' => 'Creez d\'abord un compte via admin.php avec un role non-etudiant et une agence renseignee.',
                'interim_fixes.intro.select' => 'Selectionnez un interimaire pour encoder son horaire fixe en semaine A/B et son departement.',
                'interim_fixes.user.badge' => 'Interimaire',
                'interim_fixes.hours.week_a' => 'Semaine A',
                'interim_fixes.hours.week_b' => 'Semaine B',
                'interim_fixes.hours.total' => 'Total A + B',
                'interim_fixes.hours.encoded_suffix' => 'h encodees',
                'interim_fixes.hours.unit' => 'h',
                'interim_fixes.department.label' => 'Departement',
                'interim_fixes.department.undefined' => '- Non defini -',
                'interim_fixes.department.custom_suffix' => '(personnalise)',
                ...
                'interim_fixes.table.start' => 'Heure debut',
                ...
                'interim_fixes.message.saved' => 'Horaire fixe enregistre avec succes.',
            ...
            'nl' => [
                ...
                'tile.matching.title' => 'Interim matching',
